          ...
          <div className="dialog">
            ...
            <div className="timeline">
              ...
              <div className="step">
                ...
                <div className="text">
                  <h3>Shipment currently going through custom clearance, Melbourne AU</h3>
                  <p>Signed: Fri 24 July, 10:33 am</p>
                </div>
              </div>
              ...
              <div className="step">
                ...
                <div className="text">
                  <h3>Customs clearance completed</h3>
                  <p>Signed: Wed 12 Aug, 09:21 am</p>
                </div>
              </div>
              ...
              <div className="step">
                ...
                <div className="text">
                  <h3>In transit</h3>
                  <p>Signed: Wed 12 Aug, 10:41 pm</p>
                </div>
              </div>
            </div>
